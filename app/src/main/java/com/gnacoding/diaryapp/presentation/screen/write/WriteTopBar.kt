...
import com.gnacoding.diaryapp.presentation.component.DisplayAlertDialog
import com.gnacoding.diaryapp.util.toInstant
...
fun DeleteDiaryAction(
    ...
    DisplayAlertDialog(
        title = "Delete",
        message = "Are you sure you want permanently delete this diary note '${selectedDiary?.title}'?",
