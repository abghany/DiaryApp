package com.gnacoding.home.navigation
...
import com.gnacoding.home.HomeScreen
import com.gnacoding.home.HomeViewModel
import com.gnacoding.ui.component.DisplayAlertDialog
import com.gnacoding.util.Constants
            ...
            onYesClicked = {
                viewModel.deleteAllDiaries(
                    onSuccess = {
                        Toast.makeText(
                            context,
                            "All diaries have been successfully Deleted.",
                            Toast.LENGTH_SHORT
                        ).show()
                        scope.launch {
                            drawerState.close()
